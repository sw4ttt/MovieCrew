                ...
                else
                {
                    ...
                    if(array_has($movieAPI, 'simplePlot'))
                    {
                        ...
                        else
                        {
                            ...
                            //
                            $tmpString = "";
                            //$movie->plot = str_limit($movieAPI->simplePlot,200);

                            $movie->plot = str_limit($tmpString,200);
                        }
                    }
                    else{
                        $movie->plot = 'N/A';
